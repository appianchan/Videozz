...
Video.create!(title: "Second Video", description: "This is the awesomest video ever", user_id: z.id, view_count: 5)
c = Video.last
...
Video.create!(title: "Third Video", description: "This video is better than the last", user_id: y.id, view_count: 10)
d = Video.last
