...
Video.create!(title: "Second Video", description: "This is the awesomest video ever", user_id: 2, view_count: 5)
c = Video.last
...
Video.create!(title: "Third Video", description: "This video is better than the last", user_id: 3, view_count: 10)
d = Video.last
